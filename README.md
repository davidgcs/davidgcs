...
const Studies = [
  {
    Title: "ADVANCED VOCATIONAL TRAINING IN WEB APPLICATIONS DEVELOPMENT (ASSOCIATE DEGREE)",
    Center: "IES Rey Fernando VI",
    Year: 2017,
  },
  {
    Title: "ADVANCED VOCATIONAL TRAINING IN CROSS-PLATFORM APPLICATION DEVELOPMENT (ASSOCIATE DEGREE)",
...
<div style="display:flex">
    <img src="https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/ionic-icon.png" style="width: 15px; height: 15px;">
    Ionic
    <div>
        :black_circle: :black_circle: :black_circle: :black_circle: :black_circle: :black_circle:
    </div>
...
<a href="https://github.com/davidgcs/davidgcs/blob/master/CV_DavidGomezCesteros_DIGIT_TM_II_International.pdf">:globe_with_meridians: Download CV (International DIGIT TM II version)</a>
